...
- The landscape block lives in this repo's `shared/` copy only. plato-reader and classical-philosophy-reader share the same reader core and have the same 680px-only blind spot — the port applies there too, and nobody has done it.
